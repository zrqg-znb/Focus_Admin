...
export default function AccessDenied() {
  return (
    <div className="min-h-screen cyber-bg-elevated flex items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      <div className="cyber-card max-w-xl w-full p-10 text-center relative z-10">
        ...
        <p className="text-muted-foreground leading-7 mb-8">
          当前 Focus 账号没有分配对应的 FocusAudit 页面权限。如需访问，请联系管理员分配菜单和操作权限。
        </p>
        <Link to="/account">
