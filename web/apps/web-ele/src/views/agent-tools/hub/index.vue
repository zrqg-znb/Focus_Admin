...
function openSkillAgent() {
  router.push('/agent-tools/skill-optimizer');
}
function openModels() {
  router.push('/agent-tools/model-config');
}
onMounted(loadHub);
</script>
        ...
        <div class="runs-panel">
          <div class="section-heading compact">
            ...
            <ElButton
              link
              type="primary"
              @click="router.push('/agent-tools/skill-optimizer/records')"
            >
              查看全部
            </ElButton>
          </div>
          ...
          <div v-else class="run-list">
            <div
              ...
              @click="
                router.push({
                  path: '/agent-tools/skill-optimizer',
                  query: { runId: run.id },
                })
              "
            >
