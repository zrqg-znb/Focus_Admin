...
::: info You are reading the documentation for [Vben Admin](https://github.com/jiangzhikj/zq-platform) version `5.0`!
...
- [Vben Admin](https://github.com/jiangzhikj/zq-platform) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
