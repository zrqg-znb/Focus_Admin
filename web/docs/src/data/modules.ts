...
export const focusModules: FocusModuleMeta[] = [
  ...
  },
  {
    ...
    summary:
      '面向项目代码规范执行情况的采集、对比和追踪，帮助团队识别违规趋势与整改压力。',
    tagline: '把“规范是否真的落地”从主观感受变成可以追踪的数据面板。',
    highlights: [
      '聚焦代码规范扫描结果、整改状态与项目维度统计',
      '支持总览、明细和趋势视角，方便发现长期积压问题',
      '与项目管理、代码扫描模块共同构成质量治理链路',
    ],
    audience: ['架构师', '代码治理负责人', '项目技术负责人'],
    backendPrefixes: ['/api/code-compliance'],
    frontendRoutes: ['/compliance/overview', '/compliance/detail'],
    apiFiles: ['web/apps/web-ele/src/api/compliance/index.ts'],
  ...
  },
  {
    ...
    summary:
      '用于管理自动化测试平台、车辆配置、测试用例和日报结果，构建从资产配置到结果沉淀的测试报表链路。',
    tagline: '测试结果不仅要能看，还要能回溯到平台、车辆和用例定义。',
    highlights: [
      '覆盖平台、车辆、用例、日报汇总四类主数据与结果视图',
      '支持模板下载、批量导入和日报汇总等高频操作',
