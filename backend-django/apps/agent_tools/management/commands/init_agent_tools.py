...
PERMISSIONS = {
    ...
    'code_quality_governance': [
        ...
        ('治理工作台摘要', 'agent-tools:code-quality-governance:api:workbench:view', 1, '/api/agent-tools/code-quality-governance/workbench/summary', 'GET'),
        ...
        ('项目治理概览', 'agent-tools:code-quality-governance:api:projects:overview', 1, '/api/agent-tools/code-quality-governance/projects/:id/overview', 'GET'),
        ...
        ('责任田看护人维护', 'agent-tools:code-quality-governance:api:responsibilities:caretakers', 1, '/api/agent-tools/code-quality-governance/responsibilities/:id/caretakers', 'ALL'),
        ...
        ('项目责任田矩阵', 'agent-tools:code-quality-governance:api:links:matrix', 1, '/api/agent-tools/code-quality-governance/project-responsibilities/matrix', 'GET'),
