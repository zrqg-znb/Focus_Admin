...
from .code_quality_governance.api import router as code_quality_governance_router
...
router.add_router('/code-quality-governance', code_quality_governance_router)
