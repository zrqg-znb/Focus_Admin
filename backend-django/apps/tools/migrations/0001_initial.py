...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            ], options={'db_table': 'tools_agent_skills_provider', 'ordering': ['is_deleted', '-is_active', 'name']},
        ),
        migrations.CreateModel(
            name='AgentSkill',
            fields=[
                ...
                ('sys_creator', models.ForeignKey(blank=True, db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to='core.user')),
                ('sys_modifier', models.ForeignKey(blank=True, db_constraint=False, help_text='修改人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified', to='core.user')),
            ], options={'db_table': 'tools_agent_skills_skill', 'ordering': ['is_deleted', '-sys_create_datetime']},
        ),
        migrations.CreateModel(
            name='AgentSkillRun',
            fields=[
                ...
                ('sys_creator', models.ForeignKey(blank=True, db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to='core.user')),
                ('sys_modifier', models.ForeignKey(blank=True, db_constraint=False, help_text='修改人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified', to='core.user')),
            ], options={'db_table': 'tools_agent_skills_run', 'ordering': ['-sys_create_datetime']},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sys_creator', models.ForeignKey(blank=True, db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to='core.user')),
                ('sys_modifier', models.ForeignKey(blank=True, db_constraint=False, help_text='修改人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified', to='core.user')),
            ], options={'db_table': 'tools_agent_skills_iteration', 'ordering': ['round_number'], 'unique_together': {('run', 'round_number')}},
        ),
