...
PERMISSION_SEEDS = {
    'failure_mode': [
        ...
        {'name': '导出故障模式主数据', 'code': 'failure-mode:export', 'permission_type': 0},
        ...
        {'name': '导出故障模式主数据', 'code': 'failure-mode:api:master-data:export', 'permission_type': 1, 'api_path': '/api/failure-mode/master-data/export', 'http_method': 'GET'},
        ...
        {'name': '获取故障处理措施洞察', 'code': 'failure-mode:api:measure:insight', 'permission_type': 1, 'api_path': '/api/failure-mode/handling-measures/{item_id}/insight', 'http_method': 'GET'},
        ...
        {'name': '获取维测手段洞察', 'code': 'failure-mode:api:observation:insight', 'permission_type': 1, 'api_path': '/api/failure-mode/observation-methods/{item_id}/insight', 'http_method': 'GET'},
        ...
        {'name': '获取华佗诊断方案洞察', 'code': 'failure-mode:api:huatuo:insight', 'permission_type': 1, 'api_path': '/api/failure-mode/huatuo-diagnoses/{item_id}/insight', 'http_method': 'GET'},
        ...
        {'name': '获取测试用例洞察', 'code': 'failure-mode:api:test-case:insight', 'permission_type': 1, 'api_path': '/api/failure-mode/test-cases/{item_id}/insight', 'http_method': 'GET'},
