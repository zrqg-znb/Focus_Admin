...
CMC_CONTRIBUTION_CMC_LEVEL = _env_int('CMC_CONTRIBUTION_CMC_LEVEL', 2)
CMC_CONTRIBUTION_DEPT_ID = _env_int('CMC_CONTRIBUTION_DEPT_ID', 100294)
CMC_CONTRIBUTION_FLAG = _env_int('CMC_CONTRIBUTION_FLAG', 3)
CMC_CONTRIBUTION_TAG = _env_int('CMC_CONTRIBUTION_TAG', 1)
CMC_CONTRIBUTION_SORT_TYPE = _env_str('CMC_CONTRIBUTION_SORT_TYPE', 'asc')
CMC_CONTRIBUTION_SORT_COLUMN = _env_str('CMC_CONTRIBUTION_SORT_COLUMN', 'SCORE')
CMC_CONTRIBUTION_DEPT_NAME = _env_str('CMC_CONTRIBUTION_DEPT_NAME', '底层软件开发部')
